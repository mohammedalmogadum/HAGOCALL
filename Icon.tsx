...
interface IconProps {
  as: 'Video' | 'Phone' | 'Send' | 'ArrowLeft' | 'Search' | 'Plus' | 'CheckCircle' | 'Lock' | 'Paperclip' | 'Clock' | 'ExclamationCircle';
  className?: string;
}

const ICONS: Record<IconProps['as'], React.FC<React.SVGProps<SVGSVGElement>>> = {
  Video: (props) => (
